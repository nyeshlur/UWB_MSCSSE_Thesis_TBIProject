id = "DoD111";
local_folder = "/Users/nayanayeshlur/Downloads/New_TBI_Representative_Displacement_Condensed_STDEV/" + id + "/" + id + "_";
...
% errorbar(axis, matrix_mean, matrix_stdv)
xticks(0:1:30);
grid on;
xlabel("frames");
ylabel("displacement");
...
title(myTitle);
figName = "/Users/nayanayeshlur/Downloads/New_TBI_FullyAveraged/" + id + "/" + id_angle + ".pdf";
saveas(fig, figName)

fName = "/Users/nayanayeshlur/Downloads/New_TBI_FullyAveraged/" + id + "/" + id_angle + ".mat";
